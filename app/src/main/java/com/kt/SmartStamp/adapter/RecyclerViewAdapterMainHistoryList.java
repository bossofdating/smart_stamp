...
public class RecyclerViewAdapterMainHistoryList extends RecyclerView.Adapter<RecyclerViewAdapterMainHistoryList.ViewHolder> implements View.OnClickListener {
	...
	/******************************************** 생성자 **********************************************/
	public RecyclerViewAdapterMainHistoryList(Context context, ArrayList<ServerDataContract> contractArrayList, LIST_ITEM_LISTENER EventListener) {
		// 외부변수 연결
	...
	public void onBindViewHolder(@NonNull ViewHolder Holder, int position ) {
		...
		if ("n".equals(serverDataContract.com_state)) {
			Holder.cont_state_textview.setText("등록 대기");
			Holder.cont_state_textview.setTextColor(context.getResources().getColor(R.color.commonTextGrayDeep));
		} else if ("r".equals(serverDataContract.com_state)) {
			Holder.cont_state_textview.setText("날인 대기");
			Holder.cont_state_textview.setTextColor(context.getResources().getColor(R.color.colorAccent));
		} else if ("y".equals(serverDataContract.com_state)) {
			Holder.cont_state_textview.setText("날인 완료");
	...
	public void onClick(View view) {
		...
		Intent IntentInstance = new Intent(context, DetailHistoryActivity.class );
