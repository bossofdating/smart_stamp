...
public class GridViewAdapterDocComplete extends BaseAdapter implements View.OnClickListener {
	/*************************************** 클래스 전역변수 영역 *************************************/
	...
	/******************************************* 생성자 함수 *******************************************/
	public GridViewAdapterDocComplete(Context context, ArrayList<ServerDataDoc> ArrayList_Doc, int layerWidth) {
	...
	public View getView(int Position, View ConvertView, ViewGroup Parent) {
		ConvertView = Inflater.inflate(R.layout.sublayout_gridview_doc_complete, Parent, false);
		...
		ImageView_Doc_Complete.setLayoutParams(params);
