    ...
    public void displayFragment(int FragmentIndex) {
        switch(FragmentIndex) {
            ...
            case FRAGMENT_LIST :
                ...
                Toast.makeText(this, "FRAGMENT_LIST", Toast.LENGTH_SHORT).show();
                //fragment = new FragmentMainList();
                break;
            case FRAGMENT_COMPLETE_LIST :
                titleTextView.setText("날인 완료");
                Toast.makeText(this, "FRAGMENT_COMPLETE_LIST", Toast.LENGTH_SHORT).show();
                //fragment = new FragmentMainList();
                break;
            case FRAGMENT_SETTING :
                Toast.makeText(this, "FRAGMENT_SETTING", Toast.LENGTH_SHORT).show();
                //fragment = new FragmentMainDashboard();
                break;
        }
